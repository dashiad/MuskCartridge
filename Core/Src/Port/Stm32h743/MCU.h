...
#define CRT_WAITFORCRTPHY2HIGH  DWT->CYCCNT=TIM1->CNT*2;while(DWT->CYCCNT < 245 );
...
#define CRT_SETDMAHI		HAL_GPIO_WritePin(CRT_CTRL_GPIO, CRT_PIN_DMA, GPIO_PIN_SET);
...
#define CRT_SETDMALO		HAL_GPIO_WritePin(CRT_CTRL_GPIO, CRT_PIN_DMA, GPIO_PIN_RESET);
