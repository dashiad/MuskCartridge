...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, button2_Pin|LED1_Pin|LED0_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, CS_del_TFT_Pin|debug_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : Address2_Pin Address3_Pin Address4_Pin Address5_Pin
                           ...
                           Address10_Pin Address11_Pin Address12_Pin Address13_Pin
                           Address14_Pin Address15_Pin Address0_Pin Address_1_Pin */
  GPIO_InitStruct.Pin = Address2_Pin|Address3_Pin|Address4_Pin|Address5_Pin
                          |Address6_Pin|Address7_Pin|Address8_Pin|Address9_Pin
                          |Address10_Pin|Address11_Pin|Address12_Pin|Address13_Pin
                          |Address14_Pin|Address15_Pin|Address0_Pin|Address_1_Pin;
  ...
  /*Configure GPIO pins : button1_Pin SPI_CS_Pin button3_Pin */
  GPIO_InitStruct.Pin = button1_Pin|SPI_CS_Pin|button3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : button2_Pin LED1_Pin LED0_Pin */
  GPIO_InitStruct.Pin = button2_Pin|LED1_Pin|LED0_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : Data_0_Pin Data1_Pin Data2_Pin Data3_Pin
                           Data4_Pin Data6_Pin Data7_Pin */
  GPIO_InitStruct.Pin = Data_0_Pin|Data1_Pin|Data2_Pin|Data3_Pin
                          |Data4_Pin|Data6_Pin|Data7_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pin : Data5_Pin */
  ...
  /*Configure GPIO pin : CS_del_TFT_Pin */
  GPIO_InitStruct.Pin = CS_del_TFT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(CS_del_TFT_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : BA_Pin ROMH_Pin PHI2_COPIA_Pin R_W_Pin
                           IO1_Pin IO_2_Pin ROML_Pin */
  GPIO_InitStruct.Pin = BA_Pin|ROMH_Pin|PHI2_COPIA_Pin|R_W_Pin
                          |IO1_Pin|IO_2_Pin|ROML_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);

  /*Configure GPIO pins : DMA_Pin NMI_Pin IRQ_Pin */
  GPIO_InitStruct.Pin = DMA_Pin|NMI_Pin|IRQ_Pin;
  ...
  /*Configure GPIO pins : EMAG_Pin EXROM_Pin */
  GPIO_InitStruct.Pin = EMAG_Pin|EXROM_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);
